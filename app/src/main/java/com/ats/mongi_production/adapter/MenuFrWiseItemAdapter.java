...
import static com.ats.mongi_production.fragment.FrWiseItemListFragment.menuMapFrWise;

public class MenuFrWiseItemAdapter  extends RecyclerView.Adapter<MenuFrWiseItemAdapter.MyViewHolder>  {

    private ArrayList<AllMenu> menuList;
    private Context context;
    boolean isTouched = false;

    public MenuFrWiseItemAdapter(ArrayList<AllMenu> menuList, Context context) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        menuMapFrWise.put(model.getMenuId(), true);
                        Log.e("CHECKED : ", "-----------" + model);
                        Log.e("MENU MAP : ", "--------CHECKED--------" + menuMapFrWise);
                    } else {
                        model.setCheckedStatus(false);
                        menuMapFrWise.put(model.getMenuId(), false);
                        Log.e("UN_CHECKED : ", "-----------" + model);
                        Log.e("MENU MAP : ", "---------UNCHECKED-------" + menuMapFrWise);
