...
public class DispatchMenuAdapter  extends RecyclerView.Adapter<DispatchMenuAdapter.MyViewHolder> {

    private ArrayList<AllMenu> menuList;
    private Context context;
    boolean isTouched = false;

    public DispatchMenuAdapter(ArrayList<AllMenu> menuList, Context context) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        dispatchMenuMap.put(model.getMenuId(), true);
                    } else {
                        model.setCheckedStatus(false);
                        dispatchMenuMap.put(model.getMenuId(), false);
