...
import static com.ats.mongi_production.fragment.DashboardFragment.dashMenuMapSP;

public class DashboardSPMenuAdapter extends RecyclerView.Adapter<DashboardSPMenuAdapter.MyViewHolder> {

    private ArrayList<AllMenu> menuList;
    private Context context;
    boolean isTouched = false;

    public DashboardSPMenuAdapter(ArrayList<AllMenu> menuList, Context context) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        dashMenuMapSP.put(model.getMenuId(), true);
                    } else {
                        model.setCheckedStatus(false);
                        dashMenuMapSP.put(model.getMenuId(), false);
