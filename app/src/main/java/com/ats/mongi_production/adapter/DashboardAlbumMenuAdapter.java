...
import static com.ats.mongi_production.fragment.DashboardFragment.dashMenuMapAlbum;

public class DashboardAlbumMenuAdapter extends RecyclerView.Adapter<DashboardAlbumMenuAdapter.MyViewHolder> {

    private ArrayList<AllMenu> menuList;
    private Context context;
    boolean isTouched = false;

    public DashboardAlbumMenuAdapter(ArrayList<AllMenu> menuList, Context context) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        dashMenuMapAlbum.put(model.getMenuId(), true);
                    } else {
                        model.setCheckedStatus(false);
                        dashMenuMapAlbum.put(model.getMenuId(), false);
