...
import static com.ats.mongi_production.activity.MistryWiseDateWiseReportActivity.staticWorkerMap;

public class MistryListAdapter extends RecyclerView.Adapter<MistryListAdapter.MyViewHolder> {

    private ArrayList<Employee> empList;
    private Context context;
    boolean isTouched = false;

    public MistryListAdapter(ArrayList<Employee> empList, Context context) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        final Employee model = empList.get(position);

        holder.checkBox.setText(model.getEmpName());
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        staticWorkerMap.put(model.getEmpId(), true);

                    } else {
                        model.setCheckedStatus(false);
                        staticWorkerMap.put(model.getEmpId(), false);
