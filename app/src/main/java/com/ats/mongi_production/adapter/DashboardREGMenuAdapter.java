...
import static com.ats.mongi_production.fragment.DashboardFragment.dashMenuMapREG;

public class DashboardREGMenuAdapter extends RecyclerView.Adapter<DashboardREGMenuAdapter.MyViewHolder> {

    private ArrayList<AllMenu> menuList;
    private Context context;
    boolean isTouched = false;

    public DashboardREGMenuAdapter(ArrayList<AllMenu> menuList, Context context) {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isTouched) {
                    ...
                    if (isChecked) {
                        ...
                        dashMenuMapREG.put(model.getMenuId(), true);
                    } else {
                        model.setCheckedStatus(false);
                        dashMenuMapREG.put(model.getMenuId(), false);
